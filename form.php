...
//
$mail_sys = "aboshi.daisuke@gmail.com";	// 管理者のメールアドレス
$from_name = "FTLインターナショナル";	// メール送信者の表示
$from_mail = "aboshi.daisuke@gmail.com";// メール送信者のメールアドレス（返信先）
...
$footer = "\n------------
サンプル株式会社
http://$301C$301C$301C$301C$301C.com/
------------
";
//------------------------------------------------
